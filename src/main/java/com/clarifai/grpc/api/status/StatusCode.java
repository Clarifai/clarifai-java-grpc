...
public enum StatusCode
   ...
   */
  COLLECTOR_MISSING(329, 52000),
  /**
   * <code>COLLECTOR_ACTIVE = 52001;</code>
   */
  COLLECTOR_ACTIVE(330, 52001),
  /**
   * <code>COLLECTOR_INACTIVE = 52002;</code>
   */
  COLLECTOR_INACTIVE(331, 52002),
  /**
   * <code>COLLECTOR_POST_INPUT_FAILED = 52003;</code>
   */
  COLLECTOR_POST_INPUT_FAILED(332, 52003),
  /**
   * <pre>
   * SSO 53xxx
   * </pre>
   ...
   */
  SSO_IDENTITY_PROVIDER_DOES_NOT_EXIST(333, 53001),
  /**
   * <pre>
   * Tasks 54xxx
   ...
   */
  TASK_NOT_IMPLEMENTED(340, 54101),
  /**
   * <pre>
   * Task was not found.
   * </pre>
   ...
   */
  TASK_PERMISSION_DENIED(342, 54103),
  /**
   * <pre>
   ...
   */
  TASK_ASSIGNMENT_SUCCESS(343, 54200),
  /**
   * <code>TASK_ASSIGNMENT_PENDING = 54201;</code>
   */
  TASK_ASSIGNMENT_PENDING(344, 54201),
  /**
   * <code>TASK_ASSIGNMENT_AWAITING_REVIEW = 54202;</code>
   */
  TASK_ASSIGNMENT_AWAITING_REVIEW(345, 54202),
  /**
   * <code>TASK_ASSIGNMENT_AWAITING_CONSENSUS_REVIEW = 54203;</code>
   */
  TASK_ASSIGNMENT_AWAITING_CONSENSUS_REVIEW(346, 54203),
  /**
   * <code>TASK_ASSIGNMENT_REJECTED = 54204;</code>
   */
  TASK_ASSIGNMENT_REJECTED(347, 54204),
  /**
   * <pre>
   ...
   */
  TASK_ASSIGNMENT_REVIEW_SUCCESS(348, 54300),
  /**
   * <code>TASK_ASSIGNMENT_REVIEW_PENDING = 54301;</code>
   */
  TASK_ASSIGNMENT_REVIEW_PENDING(349, 54301),
  /**
   * <code>TASK_ASSIGNMENT_REVIEW_DISMISSED = 54302;</code>
   */
  TASK_ASSIGNMENT_REVIEW_DISMISSED(350, 54302),
  /**
   * <pre>
   ...
   */
  LABEL_ORDER_PENDING(351, 55001),
  /**
   * <code>LABEL_ORDER_IN_PROGRESS = 55002;</code>
   */
  LABEL_ORDER_IN_PROGRESS(352, 55002),
  /**
   * <code>LABEL_ORDER_SUCCESS = 55003;</code>
   */
  LABEL_ORDER_SUCCESS(353, 55003),
  /**
   * <code>LABEL_ORDER_CANCELED = 55004;</code>
   */
  LABEL_ORDER_CANCELED(354, 55004),
  /**
   * <pre>
   ...
   */
  LICENSE_ACTIVE(355, 60000),
  /**
   * <code>LICENSE_DOES_NOT_EXIST = 60001;</code>
   */
  LICENSE_DOES_NOT_EXIST(356, 60001),
  /**
   * <code>LICENSE_NEED_UPDATE = 60002;</code>
   */
  LICENSE_NEED_UPDATE(357, 60002),
  /**
   * <code>LICENSE_EXPIRED = 60003;</code>
   */
  LICENSE_EXPIRED(358, 60003),
  /**
   * <code>LICENSE_REVOKED = 60004;</code>
   */
  LICENSE_REVOKED(359, 60004),
  /**
   * <pre>
   ...
   */
  LICENSE_DELETED(360, 60005),
  /**
   * <code>LICENSE_VOLUME_EXCEEDED = 60006;</code>
   */
  LICENSE_VOLUME_EXCEEDED(361, 60006),
  /**
   * <pre>
   ...
   */
  PASSWORD_VALIDATION_SUCCESS(362, 61000),
  /**
   * <code>PASSWORD_VALIDATION_FAILED = 61001;</code>
   */
  PASSWORD_VALIDATION_FAILED(363, 61001),
  /**
   * <code>PASSWORDPOLICY_INVALID_ARGUMENT = 61002;</code>
   */
  PASSWORDPOLICY_INVALID_ARGUMENT(364, 61002),
  /**
   * <pre>
   ...
   */
  FEATUREFLAG_CONFIG_NOT_FOUND(365, 62000),
  /**
   * <code>FEATUREFLAG_INVALID_ARGUMENT = 62001;</code>
   */
  FEATUREFLAG_INVALID_ARGUMENT(366, 62001),
  /**
   * <code>FEATUREFLAG_BLOCKED = 62002;</code>
   */
  FEATUREFLAG_BLOCKED(367, 62002),
  /**
   * <code>FEATUREFLAG_NOT_FOUND = 62003;</code>
   */
  FEATUREFLAG_NOT_FOUND(368, 62003),
  /**
   * <pre>
   ...
   */
  MAINTENANCE_SUCCESS(369, 63000),
  /**
   * <code>MAINTENANCE_FAILED = 63001;</code>
   */
  MAINTENANCE_FAILED(370, 63001),
  /**
   * <pre>
   * Datasets 64xxx
   ...
   */
  DATASET_VERSION_PENDING(371, 64005),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_IN_PROGRESS(372, 64010),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_READY(373, 64015),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_FAILURE(374, 64020),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_UNEXPECTED_ERROR(375, 64025),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_CONFLICT(376, 64030),
  /**
   * <pre>
   ...
   */
  DATASET_INPUT_SUCCESS(377, 64100),
  /**
   * <pre>
   ...
   */
  DATASET_INPUT_DUPLICATE(378, 64101),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_SUCCESS(379, 64200),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_PENDING(380, 64201),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_FAILED(381, 64202),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_IN_PROGRESS(382, 64203),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_UNEXPECTED_ERROR(383, 64204),
  /**
   * <pre>
   ...
   */
  AUTH_MISSING_IDP_ASSOC(392, 65000),
  /**
   * <code>LIST_OBJECTS_FAILED = 66000;</code>
   */
  LIST_OBJECTS_FAILED(393, 66000),
  /**
   * <code>ARCHIVE_EXTRACT_FAILED = 67000;</code>
   */
  ARCHIVE_EXTRACT_FAILED(394, 67000),
  /**
   * <pre>
   ...
   */
  BILLING_INVALID_INFO(402, 69000),
  /**
   * <code>BILLING_MISSING_TOKENS = 69001;</code>
   */
  BILLING_MISSING_TOKENS(403, 69001),
  /**
   * <pre>
   ...
   */
  LOG_ENTRIES_INVALID_REQUEST(404, 70000),
  /**
   * <pre>
   ...
   */
  TWILIO_MAX_VERIFICATION_BEGIN_EXCEEDED(405, 71003),
  /**
   * <code>TWILIO_MAX_VERIFICATION_CHECK_EXCEEDED = 71004;</code>
   */
  TWILIO_MAX_VERIFICATION_CHECK_EXCEEDED(406, 71004),
  /**
   * <pre>
   ...
   */
  TWILIO_PHONE_NUMBER_BLOCKED(407, 71005),
  /**
   * <pre>
