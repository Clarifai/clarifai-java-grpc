...
public enum StatusCode
   ...
   */
  SIGNUP_EVENT_ERROR(298, 46001),
  /**
   * <code>SIGNUP_FLAGGED = 46002;</code>
   */
  SIGNUP_FLAGGED(299, 46002),
  /**
   * <code>FILETYPE_UNSUPPORTED = 46003;</code>
   */
  FILETYPE_UNSUPPORTED(300, 46003),
  /**
   * <pre>
   ...
   */
  APP_COUNT_INVALID_MESSAGE(301, 47001),
  /**
   * <code>APP_COUNT_UPDATE_INCREMENT_FAILED = 47002;</code>
   */
  APP_COUNT_UPDATE_INCREMENT_FAILED(302, 47002),
  /**
   * <code>APP_COUNT_REBUILD_FAILED = 47003;</code>
   */
  APP_COUNT_REBUILD_FAILED(303, 47003),
  /**
   * <code>APP_COUNT_INTERNAL_FAILURE = 47004;</code>
   */
  APP_COUNT_INTERNAL_FAILURE(304, 47004),
  /**
   * <pre>
   ...
   */
  WORKER_MISSING(313, 51000),
  /**
   * <code>WORKER_ACTIVE = 51001;</code>
   */
  WORKER_ACTIVE(314, 51001),
  /**
   * <code>WORKER_INACTIVE = 51002;</code>
   */
  WORKER_INACTIVE(315, 51002),
  /**
   * <pre>
   * Collectors 52xxx
   * </pre>
   ...
   */
  COLLECTOR_MISSING(316, 52000),
  /**
   * <code>COLLECTOR_ACTIVE = 52001;</code>
   */
  COLLECTOR_ACTIVE(317, 52001),
  /**
   * <code>COLLECTOR_INACTIVE = 52002;</code>
   */
  COLLECTOR_INACTIVE(318, 52002),
  /**
   * <code>COLLECTOR_POST_INPUT_FAILED = 52003;</code>
   */
  COLLECTOR_POST_INPUT_FAILED(319, 52003),
  /**
   * <pre>
   * SSO 53xxx
   * </pre>
   ...
   */
  SSO_IDENTITY_PROVIDER_DOES_NOT_EXIST(320, 53001),
  /**
   * <pre>
   * Tasks 54xxx
   ...
   */
  TASK_NOT_IMPLEMENTED(327, 54101),
  /**
   * <pre>
   * Task was not found.
   * </pre>
   ...
   */
  TASK_PERMISSION_DENIED(329, 54103),
  /**
   * <pre>
   ...
   */
  TASK_ASSIGNMENT_SUCCESS(330, 54200),
  /**
   * <code>TASK_ASSIGNMENT_PENDING = 54201;</code>
   */
  TASK_ASSIGNMENT_PENDING(331, 54201),
  /**
   * <code>TASK_ASSIGNMENT_AWAITING_REVIEW = 54202;</code>
   */
  TASK_ASSIGNMENT_AWAITING_REVIEW(332, 54202),
  /**
   * <code>TASK_ASSIGNMENT_AWAITING_CONSENSUS_REVIEW = 54203;</code>
   */
  TASK_ASSIGNMENT_AWAITING_CONSENSUS_REVIEW(333, 54203),
  /**
   * <code>TASK_ASSIGNMENT_REJECTED = 54204;</code>
   */
  TASK_ASSIGNMENT_REJECTED(334, 54204),
  /**
   * <pre>
   ...
   */
  TASK_ASSIGNMENT_REVIEW_SUCCESS(335, 54300),
  /**
   * <code>TASK_ASSIGNMENT_REVIEW_PENDING = 54301;</code>
   */
  TASK_ASSIGNMENT_REVIEW_PENDING(336, 54301),
  /**
   * <code>TASK_ASSIGNMENT_REVIEW_DISMISSED = 54302;</code>
   */
  TASK_ASSIGNMENT_REVIEW_DISMISSED(337, 54302),
  /**
   * <pre>
   ...
   */
  LABEL_ORDER_PENDING(338, 55001),
  /**
   * <code>LABEL_ORDER_IN_PROGRESS = 55002;</code>
   */
  LABEL_ORDER_IN_PROGRESS(339, 55002),
  /**
   * <code>LABEL_ORDER_SUCCESS = 55003;</code>
   */
  LABEL_ORDER_SUCCESS(340, 55003),
  /**
   * <code>LABEL_ORDER_CANCELED = 55004;</code>
   */
  LABEL_ORDER_CANCELED(341, 55004),
  /**
   * <pre>
   ...
   */
  LICENSE_ACTIVE(342, 60000),
  /**
   * <code>LICENSE_DOES_NOT_EXIST = 60001;</code>
   */
  LICENSE_DOES_NOT_EXIST(343, 60001),
  /**
   * <code>LICENSE_NEED_UPDATE = 60002;</code>
   */
  LICENSE_NEED_UPDATE(344, 60002),
  /**
   * <code>LICENSE_EXPIRED = 60003;</code>
   */
  LICENSE_EXPIRED(345, 60003),
  /**
   * <code>LICENSE_REVOKED = 60004;</code>
   */
  LICENSE_REVOKED(346, 60004),
  /**
   * <pre>
   ...
   */
  LICENSE_DELETED(347, 60005),
  /**
   * <code>LICENSE_VOLUME_EXCEEDED = 60006;</code>
   */
  LICENSE_VOLUME_EXCEEDED(348, 60006),
  /**
   * <pre>
   ...
   */
  PASSWORD_VALIDATION_SUCCESS(349, 61000),
  /**
   * <code>PASSWORD_VALIDATION_FAILED = 61001;</code>
   */
  PASSWORD_VALIDATION_FAILED(350, 61001),
  /**
   * <code>PASSWORDPOLICY_INVALID_ARGUMENT = 61002;</code>
   */
  PASSWORDPOLICY_INVALID_ARGUMENT(351, 61002),
  /**
   * <pre>
   ...
   */
  FEATUREFLAG_CONFIG_NOT_FOUND(352, 62000),
  /**
   * <code>FEATUREFLAG_INVALID_ARGUMENT = 62001;</code>
   */
  FEATUREFLAG_INVALID_ARGUMENT(353, 62001),
  /**
   * <code>FEATUREFLAG_BLOCKED = 62002;</code>
   */
  FEATUREFLAG_BLOCKED(354, 62002),
  /**
   * <code>FEATUREFLAG_NOT_FOUND = 62003;</code>
   */
  FEATUREFLAG_NOT_FOUND(355, 62003),
  /**
   * <pre>
   ...
   */
  MAINTENANCE_SUCCESS(356, 63000),
  /**
   * <code>MAINTENANCE_FAILED = 63001;</code>
   */
  MAINTENANCE_FAILED(357, 63001),
  /**
   * <pre>
   * Datasets 64xxx
   ...
   */
  DATASET_VERSION_PENDING(358, 64005),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_IN_PROGRESS(359, 64010),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_READY(360, 64015),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_FAILURE(361, 64020),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_UNEXPECTED_ERROR(362, 64025),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_CONFLICT(363, 64030),
  /**
   * <pre>
   ...
   */
  DATASET_INPUT_SUCCESS(364, 64100),
  /**
   * <pre>
   ...
   */
  DATASET_INPUT_DUPLICATE(365, 64101),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_SUCCESS(366, 64200),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_PENDING(367, 64201),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_FAILED(368, 64202),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_IN_PROGRESS(369, 64203),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_UNEXPECTED_ERROR(370, 64204),
  /**
   * <pre>
   ...
   */
  AUTH_MISSING_IDP_ASSOC(378, 65000),
  /**
   * <code>LIST_OBJECTS_FAILED = 66000;</code>
   */
  LIST_OBJECTS_FAILED(379, 66000),
  /**
   * <code>ARCHIVE_EXTRACT_FAILED = 67000;</code>
   */
  ARCHIVE_EXTRACT_FAILED(380, 67000),
  /**
   * <pre>
   ...
   */
  BILLING_INVALID_INFO(388, 69000),
  /**
   * <code>BILLING_MISSING_TOKENS = 69001;</code>
   */
  BILLING_MISSING_TOKENS(389, 69001),
  /**
   * <pre>
   ...
   */
  LOG_ENTRIES_INVALID_REQUEST(390, 70000),
  /**
   * <pre>
