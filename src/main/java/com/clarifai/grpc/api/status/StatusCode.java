...
public enum StatusCode
   ...
   */
  APP_COUNT_INVALID_MESSAGE(313, 47001),
  /**
   * <code>APP_COUNT_UPDATE_INCREMENT_FAILED = 47002;</code>
   */
  APP_COUNT_UPDATE_INCREMENT_FAILED(314, 47002),
  /**
   * <code>APP_COUNT_REBUILD_FAILED = 47003;</code>
   */
  APP_COUNT_REBUILD_FAILED(315, 47003),
  /**
   * <code>APP_COUNT_INTERNAL_FAILURE = 47004;</code>
   */
  APP_COUNT_INTERNAL_FAILURE(316, 47004),
  /**
   * <pre>
   ...
   */
  WORKER_MISSING(325, 51000),
  /**
   * <code>WORKER_ACTIVE = 51001;</code>
   */
  WORKER_ACTIVE(326, 51001),
  /**
   * <code>WORKER_INACTIVE = 51002;</code>
   */
  WORKER_INACTIVE(327, 51002),
  /**
   * <pre>
   * Collectors 52xxx
   * </pre>
   ...
   */
  COLLECTOR_MISSING(328, 52000),
  /**
   * <code>COLLECTOR_ACTIVE = 52001;</code>
   */
  COLLECTOR_ACTIVE(329, 52001),
  /**
   * <code>COLLECTOR_INACTIVE = 52002;</code>
   */
  COLLECTOR_INACTIVE(330, 52002),
  /**
   * <code>COLLECTOR_POST_INPUT_FAILED = 52003;</code>
   */
  COLLECTOR_POST_INPUT_FAILED(331, 52003),
  /**
   * <pre>
   * SSO 53xxx
   * </pre>
   ...
   */
  SSO_IDENTITY_PROVIDER_DOES_NOT_EXIST(332, 53001),
  /**
   * <pre>
   * Tasks 54xxx
   ...
   */
  TASK_NOT_IMPLEMENTED(339, 54101),
  /**
   * <pre>
   * Task was not found.
   * </pre>
   ...
   */
  TASK_PERMISSION_DENIED(341, 54103),
  /**
   * <pre>
   ...
   */
  TASK_ASSIGNMENT_SUCCESS(342, 54200),
  /**
   * <code>TASK_ASSIGNMENT_PENDING = 54201;</code>
   */
  TASK_ASSIGNMENT_PENDING(343, 54201),
  /**
   * <code>TASK_ASSIGNMENT_AWAITING_REVIEW = 54202;</code>
   */
  TASK_ASSIGNMENT_AWAITING_REVIEW(344, 54202),
  /**
   * <code>TASK_ASSIGNMENT_AWAITING_CONSENSUS_REVIEW = 54203;</code>
   */
  TASK_ASSIGNMENT_AWAITING_CONSENSUS_REVIEW(345, 54203),
  /**
   * <code>TASK_ASSIGNMENT_REJECTED = 54204;</code>
   */
  TASK_ASSIGNMENT_REJECTED(346, 54204),
  /**
   * <pre>
   ...
   */
  TASK_ASSIGNMENT_REVIEW_SUCCESS(347, 54300),
  /**
   * <code>TASK_ASSIGNMENT_REVIEW_PENDING = 54301;</code>
   */
  TASK_ASSIGNMENT_REVIEW_PENDING(348, 54301),
  /**
   * <code>TASK_ASSIGNMENT_REVIEW_DISMISSED = 54302;</code>
   */
  TASK_ASSIGNMENT_REVIEW_DISMISSED(349, 54302),
  /**
   * <pre>
   ...
   */
  LABEL_ORDER_PENDING(350, 55001),
  /**
   * <code>LABEL_ORDER_IN_PROGRESS = 55002;</code>
   */
  LABEL_ORDER_IN_PROGRESS(351, 55002),
  /**
   * <code>LABEL_ORDER_SUCCESS = 55003;</code>
   */
  LABEL_ORDER_SUCCESS(352, 55003),
  /**
   * <code>LABEL_ORDER_CANCELED = 55004;</code>
   */
  LABEL_ORDER_CANCELED(353, 55004),
  /**
   * <pre>
   ...
   */
  LICENSE_ACTIVE(354, 60000),
  /**
   * <code>LICENSE_DOES_NOT_EXIST = 60001;</code>
   */
  LICENSE_DOES_NOT_EXIST(355, 60001),
  /**
   * <code>LICENSE_NEED_UPDATE = 60002;</code>
   */
  LICENSE_NEED_UPDATE(356, 60002),
  /**
   * <code>LICENSE_EXPIRED = 60003;</code>
   */
  LICENSE_EXPIRED(357, 60003),
  /**
   * <code>LICENSE_REVOKED = 60004;</code>
   */
  LICENSE_REVOKED(358, 60004),
  /**
   * <pre>
   ...
   */
  LICENSE_DELETED(359, 60005),
  /**
   * <code>LICENSE_VOLUME_EXCEEDED = 60006;</code>
   */
  LICENSE_VOLUME_EXCEEDED(360, 60006),
  /**
   * <pre>
   ...
   */
  PASSWORD_VALIDATION_SUCCESS(361, 61000),
  /**
   * <code>PASSWORD_VALIDATION_FAILED = 61001;</code>
   */
  PASSWORD_VALIDATION_FAILED(362, 61001),
  /**
   * <code>PASSWORDPOLICY_INVALID_ARGUMENT = 61002;</code>
   */
  PASSWORDPOLICY_INVALID_ARGUMENT(363, 61002),
  /**
   * <pre>
   ...
   */
  FEATUREFLAG_CONFIG_NOT_FOUND(364, 62000),
  /**
   * <code>FEATUREFLAG_INVALID_ARGUMENT = 62001;</code>
   */
  FEATUREFLAG_INVALID_ARGUMENT(365, 62001),
  /**
   * <code>FEATUREFLAG_BLOCKED = 62002;</code>
   */
  FEATUREFLAG_BLOCKED(366, 62002),
  /**
   * <code>FEATUREFLAG_NOT_FOUND = 62003;</code>
   */
  FEATUREFLAG_NOT_FOUND(367, 62003),
  /**
   * <pre>
   ...
   */
  MAINTENANCE_SUCCESS(368, 63000),
  /**
   * <code>MAINTENANCE_FAILED = 63001;</code>
   */
  MAINTENANCE_FAILED(369, 63001),
  /**
   * <pre>
   * Datasets 64xxx
   ...
   */
  DATASET_VERSION_PENDING(370, 64005),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_IN_PROGRESS(371, 64010),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_READY(372, 64015),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_FAILURE(373, 64020),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_UNEXPECTED_ERROR(374, 64025),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_CONFLICT(375, 64030),
  /**
   * <pre>
   ...
   */
  DATASET_INPUT_SUCCESS(376, 64100),
  /**
   * <pre>
   ...
   */
  DATASET_INPUT_DUPLICATE(377, 64101),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_SUCCESS(378, 64200),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_PENDING(379, 64201),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_FAILED(380, 64202),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_IN_PROGRESS(381, 64203),
  /**
   * <pre>
   ...
   */
  DATASET_VERSION_EXPORT_UNEXPECTED_ERROR(382, 64204),
  /**
   * <pre>
   ...
   */
  AUTH_MISSING_IDP_ASSOC(391, 65000),
  /**
   * <code>LIST_OBJECTS_FAILED = 66000;</code>
   */
  LIST_OBJECTS_FAILED(392, 66000),
  /**
   * <code>ARCHIVE_EXTRACT_FAILED = 67000;</code>
   */
  ARCHIVE_EXTRACT_FAILED(393, 67000),
  /**
   * <pre>
   ...
   */
  BILLING_INVALID_INFO(401, 69000),
  /**
   * <code>BILLING_MISSING_TOKENS = 69001;</code>
   */
  BILLING_MISSING_TOKENS(402, 69001),
  /**
   * <pre>
   ...
   */
  LOG_ENTRIES_INVALID_REQUEST(403, 70000),
  /**
   * <pre>
