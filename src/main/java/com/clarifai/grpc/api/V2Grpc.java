...
public final class V2Grpc {
  ...
  private static final int METHODID_GET_MODEL_TYPE = 52;
  private static final int METHODID_LIST_OPEN_SOURCE_LICENSES = 53;
  private static final int METHODID_LIST_MODEL_TYPES = 54;
  private static final int METHODID_GET_MODEL = 55;
  private static final int METHODID_GET_MODEL_OUTPUT_INFO = 56;
  private static final int METHODID_LIST_MODELS = 57;
  private static final int METHODID_POST_MODELS_SEARCHES = 58;
  private static final int METHODID_POST_MODELS = 59;
  private static final int METHODID_PATCH_MODELS = 60;
  private static final int METHODID_PATCH_MODEL_IDS = 61;
  private static final int METHODID_DELETE_MODEL = 62;
  private static final int METHODID_DELETE_MODELS = 63;
  private static final int METHODID_PATCH_MODEL_CHECK_CONSENTS = 64;
  private static final int METHODID_PATCH_MODEL_TOOLKITS = 65;
  private static final int METHODID_PATCH_MODEL_USE_CASES = 66;
  private static final int METHODID_PATCH_MODEL_LANGUAGES = 67;
  private static final int METHODID_LIST_MODEL_INPUTS = 68;
  private static final int METHODID_GET_MODEL_VERSION = 69;
  private static final int METHODID_LIST_MODEL_VERSIONS = 70;
  private static final int METHODID_POST_WORKFLOW_VERSIONS_UN_PUBLISH = 71;
  private static final int METHODID_POST_WORKFLOW_VERSIONS_PUBLISH = 72;
  private static final int METHODID_POST_MODEL_VERSIONS_PUBLISH = 73;
  private static final int METHODID_POST_MODEL_VERSIONS_UN_PUBLISH = 74;
  private static final int METHODID_POST_MODEL_VERSIONS = 75;
  private static final int METHODID_PATCH_MODEL_VERSIONS = 76;
  private static final int METHODID_DELETE_MODEL_VERSION = 77;
  private static final int METHODID_GET_MODEL_VERSION_METRICS = 78;
  private static final int METHODID_POST_MODEL_VERSION_METRICS = 79;
  private static final int METHODID_LIST_MODEL_REFERENCES = 80;
  private static final int METHODID_GET_MODEL_VERSION_INPUT_EXAMPLE = 81;
  private static final int METHODID_LIST_MODEL_VERSION_INPUT_EXAMPLES = 82;
  private static final int METHODID_GET_WORKFLOW = 83;
  private static final int METHODID_LIST_WORKFLOWS = 84;
  private static final int METHODID_POST_WORKFLOWS = 85;
  private static final int METHODID_PATCH_WORKFLOWS = 86;
  private static final int METHODID_DELETE_WORKFLOW = 87;
  private static final int METHODID_DELETE_WORKFLOWS = 88;
  private static final int METHODID_POST_WORKFLOW_RESULTS = 89;
  private static final int METHODID_POST_WORKFLOW_RESULTS_SIMILARITY = 90;
  private static final int METHODID_LIST_WORKFLOW_VERSIONS = 91;
  private static final int METHODID_GET_WORKFLOW_VERSION = 92;
  private static final int METHODID_DELETE_WORKFLOW_VERSIONS = 93;
  private static final int METHODID_PATCH_WORKFLOW_VERSIONS = 94;
  private static final int METHODID_GET_KEY = 95;
  private static final int METHODID_LIST_KEYS = 96;
  private static final int METHODID_LIST_APP_KEYS = 97;
  private static final int METHODID_DELETE_KEY = 98;
  private static final int METHODID_POST_KEYS = 99;
  private static final int METHODID_PATCH_KEYS = 100;
  private static final int METHODID_MY_SCOPES = 101;
  private static final int METHODID_MY_SCOPES_USER = 102;
  private static final int METHODID_MY_SCOPES_ROOT = 103;
  private static final int METHODID_LIST_SCOPES = 104;
  private static final int METHODID_GET_APP = 105;
  private static final int METHODID_LIST_APPS = 106;
  private static final int METHODID_DELETE_APP = 107;
  private static final int METHODID_POST_APPS = 108;
  private static final int METHODID_PATCH_APPS = 109;
  private static final int METHODID_PATCH_APPS_IDS = 110;
  private static final int METHODID_PATCH_APP = 111;
  private static final int METHODID_POST_APPS_SEARCHES = 112;
  private static final int METHODID_POST_VALIDATE_PASSWORD = 113;
  private static final int METHODID_GET_SEARCH = 114;
  private static final int METHODID_LIST_SEARCHES = 115;
  private static final int METHODID_PATCH_SEARCHES = 116;
  private static final int METHODID_POST_SEARCHES = 117;
  private static final int METHODID_POST_SEARCHES_BY_ID = 118;
  private static final int METHODID_POST_ANNOTATION_SEARCH_METRICS = 119;
  private static final int METHODID_GET_ANNOTATION_SEARCH_METRICS = 120;
  private static final int METHODID_LIST_ANNOTATION_SEARCH_METRICS = 121;
  private static final int METHODID_DELETE_ANNOTATION_SEARCH_METRICS = 122;
  private static final int METHODID_DELETE_SEARCH = 123;
  private static final int METHODID_LIST_ANNOTATION_FILTERS = 124;
  private static final int METHODID_GET_ANNOTATION_FILTER = 125;
  private static final int METHODID_POST_ANNOTATION_FILTERS = 126;
  private static final int METHODID_PATCH_ANNOTATION_FILTERS = 127;
  private static final int METHODID_DELETE_ANNOTATION_FILTERS = 128;
  private static final int METHODID_LIST_STATUS_CODES = 129;
  private static final int METHODID_GET_STATUS_CODE = 130;
  private static final int METHODID_LIST_COLLABORATORS = 131;
  private static final int METHODID_POST_COLLABORATORS = 132;
  private static final int METHODID_PATCH_COLLABORATORS = 133;
  private static final int METHODID_DELETE_COLLABORATORS = 134;
  private static final int METHODID_LIST_COLLABORATIONS = 135;
  private static final int METHODID_POST_APP_DUPLICATIONS = 136;
  private static final int METHODID_LIST_APP_DUPLICATIONS = 137;
  private static final int METHODID_GET_APP_DUPLICATION = 138;
  private static final int METHODID_POST_TASKS = 139;
  private static final int METHODID_GET_TASK_ANNOTATION_COUNT = 140;
  private static final int METHODID_GET_TASK_INPUT_COUNT = 141;
  private static final int METHODID_GET_TASK = 142;
  private static final int METHODID_LIST_TASKS = 143;
  private static final int METHODID_PATCH_TASKS = 144;
  private static final int METHODID_DELETE_TASKS = 145;
  private static final int METHODID_POST_LABEL_ORDERS = 146;
  private static final int METHODID_GET_LABEL_ORDER = 147;
  private static final int METHODID_LIST_LABEL_ORDERS = 148;
  private static final int METHODID_PATCH_LABEL_ORDERS = 149;
  private static final int METHODID_DELETE_LABEL_ORDERS = 150;
  private static final int METHODID_POST_COLLECTORS = 151;
  private static final int METHODID_GET_COLLECTOR = 152;
  private static final int METHODID_LIST_COLLECTORS = 153;
  private static final int METHODID_PATCH_COLLECTORS = 154;
  private static final int METHODID_DELETE_COLLECTORS = 155;
  private static final int METHODID_POST_STAT_VALUES = 156;
  private static final int METHODID_POST_STAT_VALUES_AGGREGATE = 157;
  private static final int METHODID_POST_TRENDING_METRICS_VIEW = 158;
  private static final int METHODID_LIST_TRENDING_METRICS_VIEWS = 159;
  private static final int METHODID_GET_MODULE = 160;
  private static final int METHODID_LIST_MODULES = 161;
  private static final int METHODID_POST_MODULES = 162;
  private static final int METHODID_PATCH_MODULES = 163;
  private static final int METHODID_DELETE_MODULES = 164;
  private static final int METHODID_GET_MODULE_VERSION = 165;
  private static final int METHODID_LIST_MODULE_VERSIONS = 166;
  private static final int METHODID_POST_MODULE_VERSIONS = 167;
  private static final int METHODID_DELETE_MODULE_VERSIONS = 168;
  private static final int METHODID_LIST_INSTALLED_MODULE_VERSIONS = 169;
  private static final int METHODID_POST_INSTALLED_MODULE_VERSIONS = 170;
  private static final int METHODID_DELETE_INSTALLED_MODULE_VERSIONS = 171;
  private static final int METHODID_POST_BULK_OPERATIONS = 172;
  private static final int METHODID_LIST_BULK_OPERATIONS = 173;
  private static final int METHODID_GET_BULK_OPERATION = 174;
  private static final int METHODID_CANCEL_BULK_OPERATIONS = 175;
  private static final int METHODID_DELETE_BULK_OPERATIONS = 176;
  private static final int METHODID_GET_DATASET_INPUTS_SEARCH_ADD_JOB = 177;
