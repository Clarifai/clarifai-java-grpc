...
public interface DatasetVersionMetricsOrBuilder extends
   ...
   */
  com.clarifai.grpc.api.utils.Matrix.MatrixUint64 getRegionLocationMatrix();
  /**
   * <pre>
   * The matrix shows where the regions are located.
   * Example: If the matrix has 2x2 dimensions, then
   ...
   * <code>.MatrixUint64 region_location_matrix = 21;</code>
   */
  com.clarifai.grpc.api.utils.Matrix.MatrixUint64OrBuilder getRegionLocationMatrixOrBuilder();
